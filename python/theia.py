    ...
    def compare_pixles(self, object_list1, object_list2, pic):
        ...
        for obj1 in object_list1:
            for obj2 in object_list2:
                if obj1.position[1]-100 <= obj2.position[1] <= obj1.position[1]+100:
                    print(obj1.position)
                    crop1 = gray[0][obj1.rectangle[0][1]+20:obj1.rectangle[0][1]+obj1.height-20, obj1.rectangle[0][0]+20:obj1.rectangle[0][0]+obj1.width-20]
                    ...
                    offset = obj1.obj1.rectangle[0][0]- obj2.rectangle[0][0]

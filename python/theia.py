            ...
            for obj2 in object_list2:
                if obj1.position[1]-100 <= obj2.position[1] <= obj1.position[1]+100:
                    if obj1.width-50 <= obj2.width <= obj1.width+50:
                        crop1 = gray[0][int(obj1.rectangle[0][1]+obj1.height):int(obj1.rectangle[0][1]+obj1.height), int(obj1.rectangle[0][0]+obj1.width):int(obj1.rectangle[0][0]+obj1.width)]
                        crop2 = gray[1][int(obj2.rectangle[0][1]+obj1.height):int(obj2.rectangle[0][1]+obj1.height), int(obj2.rectangle[0][0]+obj1.width):int(obj2.rectangle[0][0]+obj1.width)]

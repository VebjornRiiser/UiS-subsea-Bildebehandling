...
mtx1, dist1 = calibrate_camera(images_folder = '/home/subsea/Bilete/D2/*')
mtx2, dist2 = calibrate_camera(images_folder = '/home/subsea/Bilete/J2/*')
 
R, T = stereo_calibrate(mtx1, dist1, mtx2, dist2, '/home/subsea/Bilete/synched/*')

with open(f'cal_cam.npy', 'wb') as f:
    np.save(f, mtx1)
    np.save(f, dist1)
    np.save(f, mtx2)
    np.save(f, dist2)
